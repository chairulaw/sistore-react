...
const NavCategory = () => {
  ...
  return (
    <div className="relative w-full max-w-screen-2xl flex flex-col md:flex-row items-center mx-auto mt-28 px-4">
      {/* Title */}
      <h1 className="text-xl sm:text-2xl md:text-3xl font-bold text-[#153448] mb-4 md:mb-0 md:mr-5">
        {activeCategory}
      </h1>

      {/* Category Navigation (Background lebih panjang) */}
      <div className="bg-[#DFD0B8] p-3 sm:p-5 rounded-2xl w-full md:flex-1 flex md:flex-row flex-wrap  gap-3 sm:gap-5">
