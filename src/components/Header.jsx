    ...
    <header className="fixed flex w-full z-50 items-center justify-between bg-white p-5">
      ...
      <div className="hidden md:flex gap-6 items-center">
        ...
        <div className="flex items-center gap-3">
          <Link to="/login" className="cursor-pointer font-bold border bg-[#153448] text-[#DFD0B8] px-4 py-2 rounded-2xl hover:bg-[#DFD0B8] hover:text-[#153448] ease-in-out duration-300">
            Login
          </Link>
          <Link to="/signup" className="cursor-pointer font-bold border border-[#153448] text-[#153448] px-4 py-2 rounded-2xl hover:bg-[#DFD0B8] hover:text-[#153448] ease-in-out duration-300">
            Sign Up
          </Link>
        </div>
      </div>
